package com.singhand.sd.template.bizkeycloakmodel.service;

import cn.hutool.core.collection.CollUtil;
import cn.hutool.core.util.StrUtil;
import cn.hutool.json.JSONObject;
import com.singhand.sd.template.bizkeycloakmodel.helper.JwtHelper;
import com.singhand.sd.template.bizkeycloakmodel.model.Role;
...
import com.singhand.sd.template.bizkeycloakmodel.repository.EventEntityRepository;
...
import com.singhand.sd.template.bizkeycloakmodel.model.UserEntity_;
import com.singhand.sd.template.bizkeycloakmodel.model.request.NewUserRequest;
import com.singhand.sd.template.bizkeycloakmodel.model.request.RegisterUserRequest;
...
public class KeycloakUserService {
  ...
  public void resetUserCredentialById(String id) {
    ...
    final var credentialRepresentation = new CredentialRepresentation();
    credentialRepresentation.setType("password");
    credentialRepresentation.setValue("Aa123456.");
    credentialRepresentation.setTemporary(false);
    userRepresentation.setCredentials(List.of(credentialRepresentation));
    userResource.update(userRepresentation);
  }

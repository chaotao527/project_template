...
import com.singhand.sd.template.bizservice.service.MinioService;
...
public class S3Controller {
  ...
  private final static Map<String, Set<String>> LEGAL_DIRECTORIES = new HashMap<>() {{
    ...
    put("import_evaluation", Set.of("evaluation:import_and_export", "evaluation:read"));
    put("import_work_orders", Set.of("work_order:import_and_export"));

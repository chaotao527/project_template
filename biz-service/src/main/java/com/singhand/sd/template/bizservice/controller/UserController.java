...
import com.singhand.sd.template.bizkeycloakmodel.helper.JwtHelper;
import com.singhand.sd.template.bizkeycloakmodel.model.Group;
import com.singhand.sd.template.bizkeycloakmodel.model.User;
import com.singhand.sd.template.bizkeycloakmodel.model.UserAttribute;
import com.singhand.sd.template.bizkeycloakmodel.model.request.AcceptUserRequest;
import com.singhand.sd.template.bizkeycloakmodel.model.request.NewUserRequest;
import com.singhand.sd.template.bizkeycloakmodel.model.request.RejectUserRequest;
import com.singhand.sd.template.bizkeycloakmodel.model.request.UpdateUserRequest;
import com.singhand.sd.template.bizkeycloakmodel.repository.UserEntityRepository;
import com.singhand.sd.template.bizkeycloakmodel.service.KeycloakClientService;
...
import com.singhand.sd.template.bizkeycloakmodel.validator.NotContainsSuperAdminUserId;
import com.singhand.sd.template.bizkeycloakmodel.validator.NotSuperAdminUserId;
import com.singhand.sd.template.bizservice.annotation.bizlogger.BizLogger;
import com.singhand.sd.template.bizservice.annotation.resolver.GetNameByUserIdInPathResolver;
import com.singhand.sd.template.bizservice.annotation.resolver.GetNameByUserIdsInPathResolver;
import com.singhand.sd.template.bizservice.annotation.resolver.GetUserNameByUserIdInResolver;
import com.singhand.sd.template.bizservice.annotation.resolver.Resolve;
import com.singhand.sd.template.bizservice.service.NotificationService;
...
public class UserController {
  ...
  @BizLogger(module = @Resolve("'用户管理'"), type = "新建",
  ...
  @BizLogger(module = @Resolve("'用户管理'"), type = "编辑",
  ...
  public void rejectUser(@NotContainsSuperAdminUserId @PathVariable("id") List<String> ids,
    ...
    for (final var id : ids) {
      ...
      notificationService.createUserNotification(id, "系统消息",
          String.format("您的注册账号申请被驳回，审批意见：%s",

package com.singhand.sd.template.bizservice.datasource;
...
@EnableJpaRepositories(
    basePackages = "com.singhand.sd.template.bizkeycloakmodel.repository",
...
public class Keycloak {
  ...
  public LocalContainerEntityManagerFactoryBean keycloakEntityManager() {
    ...
    em.setPackagesToScan("com.singhand.sd.template.bizkeycloakmodel.model");

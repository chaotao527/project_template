package com.singhand.sd.template.bizmodel.datasource;

import com.singhand.sd.template.bizmodel.repository.BaseRepositoryImpl;
...
@EnableJpaRepositories(
    ...
    basePackages = "com.singhand.sd.template.bizmodel.repository",
...
public class Biz {
  ...
  public LocalContainerEntityManagerFactoryBean bizEntityManagerForTest() {
    ...
    em.setPackagesToScan("com.singhand.sd.template.bizmodel.model");
